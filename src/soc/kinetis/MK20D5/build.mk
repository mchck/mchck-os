...
SRCS-kinetis=	adc.c crc.c flashconfig.c ftfl.c ftm.c gpio.c i2c.c pin.c pin_change.c pit.c rtc.c dspi.c stdio.c timeout.c uart.c uart-fifo.c usb.c wdog.c sys-register.c
