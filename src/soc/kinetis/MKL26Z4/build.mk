...
SRCS-kinetis=	adc.c crc.c cop.c flash.c flashconfig.c ftfa.c gpio.c i2c.c pin.c pin_change.c pit.c rtc.c spi.c stdio.c timeout.c uart.c usb.c sys-register.c
